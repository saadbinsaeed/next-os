...
import  { browserHistory, Link } from 'react-router';
 ...
 import loginCss from 'bluerain-bootstrap-theme/dist/css/components/login.css';
import flexLayoutcss from 'bluerain-bootstrap-theme/dist/css/layouts/flexbox-layout.css';
import centerLayoutcss from 'bluerain-bootstrap-theme/dist/css/layouts/absolute-center-layout.css';
...
class LoginComponent extends React.Component {
  ...
  handleEmailChange(event) {bluerain-bootstrap-theme.css
    this.setState({
  ...
  render() {
    ...
    return (
      <div>
        ...
        <style dangerouslySetInnerHTML={{ __html: loginCss + flexLayoutcss +  centerLayoutcss}} />
        {/*<link rel="stylesheet" href="bluerain-bootstrap-theme/dist/css/components/data-list.css" />
